...
<a style="color: blue" href="${pageContext.request.contextPath}/sadmin/listAllAdmin.do">查看所有管理员信息</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
<a style="color: blue" href="${pageContext.request.contextPath}/sadmin/addUser.do">新增用户信息</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
<a style="color: blue" href="${pageContext.request.contextPath}/sadmin/addAdmin.do">新增管理员信息</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
<div class="result-box">
    ...
    <div class="table_div">
        ...
        <form id="UserForm" action="${pageContext.request.contextPath}/sadmin/insertAdmin.do" method="post">
            <div class="center_center">
                <div class="table_content">
                    <table border="10px" cellspacing="2px" cellpadding=2px">
                        ...
                        <tbody>
                        <tr>
                            <td width="12%"><input type="text" name="username" value="${myUser.username}"
                                                   style="width: 100%; height: 100%"></td>
                            <td width="12%"><input type="text" name="password" value="${myUser.password}"
                                                   style="width: 100%; height: 100%"></td>
                            <td width="12%"><input type="text" name="gender" value="${myUser.gender}"
                                                   style="width: 100%; height: 100%"></td>
                            <td width="12%"><input type="text" name="email" value="${myUser.email}"
                                                   style="width: 100%; height: 100%"></td>
                            <td width="12%"><input type="text" name="phone" value="${myUser.phone}"
                                                   style="width: 100%; height: 100%"></td>
                            <td width="12%"><input type="text" name="attendance" value="${myUser.attendance}"
                                                   style="width: 100%; height: 100%"></td>
